...
/** class Utility, used to take input of array and call the method changedArray,
 * and print array after changing positions 
*/
public class Utility {
    public void execute(){
        ...
        try{
            ...
            result = operation.changedArray(arr, X, Y);
